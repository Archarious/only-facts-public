...
import DogAvatar from "./assets/3b352062c1a643f639a36cde0bb7439d87d637b5.png";
...
<Meta title="Project Documentation" />

<div className="sb-container">
  <div className='sb-section-title'>
    # Gambling Regulation Dashboard

    Персональные дашборды для авторизованных клиентов для сбора новостей и аналитики по регулированию азартных игр из разных стран.
  </div>
</div>
<div className="sb-container">
  <div className='sb-section-title'>
