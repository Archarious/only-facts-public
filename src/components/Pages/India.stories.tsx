...
const penaltiesOperationsOptions = [
  { value: 'federal', label: 'Федеральный уровень' },
  { value: 'nagaland', label: 'Нагаленд' },
  { value: 'sikkim', label: 'Сикким' },
  { value: 'tamil-nadu', label: 'Тамил Наду' },
          ...
          <div className="flex gap-4">
            ...
            >
              <div className="h-full flex flex-col justify-between">
                <TypographyH3 className="mb-2">Для директора и иных ответственных лиц действуют те же санкции включая уголовное преследование</TypographyH3>
                <p className="text-sm">
                  В случае если нарушение совершено юридическим лицом ответственность несут директор и иные ответственные лица если было установлено что они знали о нарушении или не приняли меры для его предотвращения. 
                </p>
              </div>
            </Card>
            <Card 
            ...
            >
              <div className="h-full flex flex-col justify-between">
                ...
                >Для директора и иных ответственных лиц действуют те же санкции включая уголовное преследование</TypographyH3>
                <p className="text-sm">
                  В случае если нарушение совершено юридическим лицом ответственность несут директор и иные ответственные лица если было установлено что они знали о нарушении или не приняли меры для его предотвращения. 
                </p>
              </div>
          ...
          <div className="flex gap-4">
            ...
            >
              <div className="h-full flex flex-col justify-between">
                ...
                >Нелицензированное оперирование</TypographyH3>
              </div>
            </Card>
            <Card 
              width={8}
            ...
            >
              <div className="h-full flex flex-col justify-between">
                <TypographyH3
                  color="var(--color-palette-red-100)"
                >до 3 месяцев или  INR 200</TypographyH3>
                <p className="text-sm">
