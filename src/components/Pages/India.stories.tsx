...
import { TypographyH2, TypographyH3, TypographyParagraph, CaptionTitle, TileTypography } from '@/components/Typography'
  ...
  render: (args) => {
    ...
    <>
      <FloatingMenu 
        ...
        heroRef={heroRef}
      />
      <div className="flex flex-col p-4 items-center min-h-screen bg-white">
        <Hero
          menu={mainMenu}
          ref={heroRef}
        />
        ...
        <div id="search" className='w-full max-w-(--sizes-max-container-width) mx-auto flex flex-col gap-10'>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            >
              <div className="h-full flex flex-col justify-between">
                ...
                <div className="flex flex-row h-full w-full py-10 text-sm justify-between">
                  <div className="flex flex-col h-full justify-between">
                    <svg width="272" height="68" viewBox="0 0 272 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M29.8903 19.4074C30.3801 19.5173 30.8963 19.3826 31.2489 19.03C31.6016 18.6774 31.7361 18.161 31.6264 17.6714C31.1867 15.8758 29.5674 9.86283 27.9046 8.20007C25.8329 6.12848 22.4612 6.11985 20.3998 8.18119C18.3386 10.2424 18.3469 13.614 20.4187 15.6857C22.1087 17.3757 28.0947 18.9679 29.8903 19.4074Z" stroke="#FFA600" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M34.9184 17.6713C34.8084 18.1611 34.9432 18.6772 35.2958 19.0298C35.6484 19.3825 36.1648 19.517 36.6544 19.4073C38.4501 18.9677 44.4632 17.3484 46.126 15.6856C48.1976 13.614 48.2063 10.2424 46.1449 8.18105C44.0836 6.11986 40.7119 6.12819 38.6401 8.19993C36.9501 9.8899 35.3579 15.8757 34.9184 17.6713Z" stroke="#FFA600" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M6.80078 23.7594C6.80078 22.6669 7.68645 21.7812 8.77898 21.7812L59.2231 21.7813C60.3157 21.7813 61.2013 22.6669 61.2013 23.7594V33.6502C61.2013 34.7427 60.3157 35.6283 59.2231 35.6283L8.77898 35.6283C7.68645 35.6283 6.80078 34.7427 6.80078 33.6502L6.80078 23.7594Z" stroke="#DA3E22" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M11.7463 59.3661C11.7463 60.4586 12.632 61.3442 13.7245 61.3442L54.2776 61.3442C55.3701 61.3442 56.2558 60.4586 56.2558 59.3661V35.6283L11.7463 35.6283L11.7463 59.3661Z" stroke="#DA3E22" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M34 61L34 19" stroke="#FFA600" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p><strong>Бонус на первый депозит</strong></p>
                  </div>
                  <div>
                    <svg width="272" height="68" viewBox="0 0 272 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M61.2013 18.6998C61.2013 24.3331 49.0233 28.8997 34.0011 28.8997C18.9788 28.8997 6.80078 24.3331 6.80078 18.6998M61.2013 18.6998C61.2013 13.0666 49.0233 8.5 34.0011 8.5C18.9788 8.5 6.80078 13.0666 6.80078 18.6998M61.2013 18.6998L61.2013 49.2993C61.2013 54.9326 49.0233 59.4992 34.0011 59.4992C18.9788 59.4992 6.80078 54.9326 6.80078 49.2993L6.80078 18.6998M61.2013 33.9996C61.2013 39.6328 49.0233 44.1994 34.0011 44.1994C18.9788 44.1994 6.80078 39.6328 6.80078 33.9996" stroke="#DA3E22" stroke-width="4"/>
                      <path d="M61.2013 18.6998C61.2013 24.3331 49.0233 28.8997 34.0011 28.8997C18.9788 28.8997 6.80078 24.3331 6.80078 18.6998C6.80078 13.0666 18.9788 8.5 34.0011 8.5C49.0233 8.5 61.2013 13.0666 61.2013 18.6998Z" stroke="#FFA600" stroke-width="4"/>
                    </svg>
                    <p><strong>Бонус на первый депозит</strong></p>
                  </div>
                  <div>
                    <svg width="272" height="68" viewBox="0 0 272 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M46.3609 41.4143C46.3609 52.3393 37.5042 61.1958 26.5789 61.1958C15.6536 61.1958 6.79687 52.3393 6.79687 41.4143C6.79687 30.4893 15.6536 21.6328 26.5789 21.6328C37.5042 21.6328 46.3609 30.4893 46.3609 41.4143Z" stroke="#DA3E22" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M28.8984 11.2645C32.3091 8.47223 36.6696 6.79688 41.4214 6.79688C52.3467 6.79688 61.2034 15.6534 61.2034 26.5784C61.2034 31.3279 59.5295 35.6865 56.7395 39.0964" stroke="#FFA600" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p><strong>Бонус на первый депозит</strong></p>
                  </div>
                </div>
        ...
        <div id="licenses" className='w-full max-w-(--sizes-max-container-width) mx-auto flex flex-col gap-10'>
        ...
        <div>
          <div id="partners" className='w-full max-w-(--sizes-max-container-width) mx-auto flex flex-col gap-10'>
            <TypographyH2 className="mb-2">Регистрационные флоу у конкурентов</TypographyH2>
            <TypographyParagraph>
              В Индии стоимость привлечения аудитории одна из самых низких в мире на текущий момент, при этом выплаты от операторов сопоставимы со СНГ и Европой, что формирует очень выгодную экономику юнита. Средний чек приблизительно сопоставим с показателями стран СНГ, что делает индийский трафик привлекательным в пересчёте на конверсию в депозит.
            </TypographyParagraph>
            <MultiSelectFilters
          ...
          <div className="flex flex-wrap gap-4">
            ...
            >
              <div className="h-full flex flex-col justify-between">
                ...
                <TileTypography.Body>
                  Используются разные технические реализации UPI, подтверждение вручную
                </TileTypography.Body>
              </div>
            </Card>
            <Card 
            ...
            >
              <div className="h-full flex flex-col justify-between">
                <TileTypography.H2>
                  Рынок фрагментиро-ван, решений много, стандартов нет
                </TileTypography.H2>
              </div>
            </Card>
          </div>
    ...
    >
      <div id="insights" className='w-full max-w-(--sizes-max-container-width) mx-auto flex flex-col gap-10'>
