...
interface AdvertisingRestrictionsData {
  title?: string;
  description?: string;
...
const dataObject: AdvertisingRestrictionsData = {
  title: 'Ограничения рекламы',
...
export const AdvertisingRestrictions: React.FC = () => {
  return (
